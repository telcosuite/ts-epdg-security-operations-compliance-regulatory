...
Phase rationale: The planning repository currently contains planning, database, TMF reference, and generated backlog artifacts but no runnable GitHub implementation repository for `security-operations-compliance-regulatory`. This phase bootstraps app repository `ts-epdg-security-operations-compliance-regulatory` with Angular/PrimeNG frontend, Spring Boot backend, PostgreSQL migration baseline, contracts, security context, event/outbox baseline, local Docker Compose workflow, GitHub Actions from `ts-shared-pipeline-templates`, Kubernetes/Helm deployment skeleton, observability, and a proof vertical slice before feature implementation begins.

Phase exit gate: A developer can clone `ts-epdg-security-operations-compliance-regulatory`, run the Angular shell and Spring Boot service, apply app-owned migrations for `security_compliance_regulatory`, execute baseline tests, validate Docker Compose and Kubernetes/Helm deployment assets, and prove a minimal UI-to-API-to-database-to-audit/event path with tracker evidence.
...
- Creates the runnable GitHub app repository `ts-epdg-security-operations-compliance-regulatory` and app surface needed before domain feature phases can be built.
...
- Adopts the TMF-aligned primary APIs: TMF720, TMF672, TMF696, TMF621, TMF644, TMF667, TMF707, TMF710.

## Default Scaffold Targets

Use these app-repository-relative targets for `ts-epdg-security-operations-compliance-regulatory` unless `DT-01-security-operations-compliance-regulatory-P01-T001` records an approved architecture exception:

- GitHub app repository: `ts-epdg-security-operations-compliance-regulatory` with `README.md`, `OWNERS.md`, `CODEOWNERS`, protected `main`, required GitHub Actions checks, security scanning, copied `dev-tasks/`, and planning source commit/link recorded in `docs/architecture.md` or an ADR.
- Shared prerequisites: consume versioned UI/design-system assets from `ts-shared-ui-design-system` and GitHub Actions workflow templates from `ts-shared-pipeline-templates`; app-specific UI, domain logic, migrations, and telecom lifecycle decisions remain in `ts-epdg-security-operations-compliance-regulatory`.
...
- Spring Boot service: `backend/` with package `com.telcosuite.epdg.security_compliance_regulatory`, including `controller/`, `service/`, `domain/`, `repository/`, `security/`, `events/`, and `config/`.
...
- Database migrations: `database/postgres/migrations/` and `database/postgres/seeds/` with app-owned changes for schema `security_compliance_regulatory`, audit/evidence, idempotency, outbox, seed/demo data, and rollback/repair notes.
...
### DT-01-security-operations-compliance-regulatory-P01-T001: Bootstrap GitHub app repository and ownership boundary

| Field | Value |
| --- | --- |
| Phase | P01 - From Scratch App Foundation And Delivery Runtime |
| Priority | P0 |
| Source evidence | [Implementation usage](../planning/app-detail/implementation-file-usage.md), [App README](../README.md), [App overview](../../security-operations-compliance-regulatory.md), [Modules and features](../planning/app-detail/modules-and-features.md), [Personas and journeys](../planning/app-detail/personas-and-user-journeys.md), [Suite tech/UI guidance](../../tech-and-ui-guidance.md), [Suite data model](../../data-model.md), [Suite implementation guide](../../implementation-file-usage-guide.md), [TMF review](../../tmf-api-ddl-reviews/security-compliance-regulatory.md), [App migration](../../../../../database/postgres/suites/ts_enterprise_platform_governance/V001__create_app_schemas_and_starter_tables.sql), [API-first architecture](../../../../api-first-product-suite-architecture.md), [Technology stack guidance](../../../../technology-stack-guidance.md), [UI design system](../../../../telcosuite-ui-design-system.md), [Database setup guidance](../../../../recommended-database-setup.md), [Data mastery ownership](../../../../data-mastery-entity-ownership.md) |
| Feature or module | From-scratch app foundation |
| Build area | Architecture/Docs |
| Dependencies | External: suite/app evidence chain |
| Outputs | GitHub repository `ts-epdg-security-operations-compliance-regulatory`, app boundary decision, copied `dev-tasks/`, ownership files, branch protection/check policy, app-root workspace names, and source-evidence map. |

#### Implementation Notes

- Confirm that `ts-epdg-security-operations-compliance-regulatory` is the implementation repository for this app and record the intended frontend, backend, database, test, CI, Docker Compose, Kubernetes/Helm, and deployment locations before code scaffolding starts.
- Map the app-owned schema `security_compliance_regulatory`, TMF/API posture (TMF720, TMF672, TMF696, TMF621, TMF644, TMF667, TMF707, TMF710), personas, feature folders, repository ownership, shared repository dependencies, and cross-app boundaries to concrete implementation artifacts.
...
- Default artifact map: GitHub repo `ts-epdg-security-operations-compliance-regulatory` with app-root `frontend/`, `backend/`, `contracts/openapi/v1/openapi.yaml`, `contracts/events/`, `database/postgres/migrations/`, `database/postgres/seeds/`, `docs/`, `dev-tasks/`, `.github/workflows/ci.yml`, `.github/workflows/release.yml`, `deploy/compose/`, `deploy/k8s/`, and `deploy/helm/`.
- Bootstrap governance files: `README.md`, `OWNERS.md`, `CODEOWNERS`, branch protection configuration or evidence, required GitHub Actions checks, and security scanning policy for `ts-epdg-security-operations-compliance-regulatory`.
...
2. Given `security-operations-compliance-regulatory` uses app-owned schema `security_compliance_regulatory`, when the task creates code, config, migrations, contracts, or test fixtures, then writes remain inside that schema and cross-app data access is represented as API, event, workflow, projection, or data product dependency.
...
5. Given a clean checkout of `ts-epdg-security-operations-compliance-regulatory`, when the documented commands are run in dependency order, then the task output is reproducible without manual, undocumented setup.
6. Given `ts-epdg-security-operations-compliance-regulatory` is bootstrapped, when repository governance is reviewed, then `README.md`, `OWNERS.md`, `CODEOWNERS`, branch protection evidence, required GitHub Actions checks, security scanning, copied `dev-tasks/`, and planning source commit/link are present.
...
### DT-01-security-operations-compliance-regulatory-P01-T002: Create Angular application shell and suite navigation entry

| Field | Value |
| --- | --- |
| Phase | P01 - From Scratch App Foundation And Delivery Runtime |
| Priority | P0 |
| Source evidence | [UI design system](../../../../../telcosuite-ui-design-system.md), [App summary](../../../../../security-operations-compliance-regulatory.md), [Personas](../../../../../security-operations-compliance-regulatory-personas.md) |
| Feature or module | From-scratch app foundation |
| Build area | UI |
| Dependencies | DT-01-security-operations-compliance-regulatory-P01-T001 |
...
### DT-01-security-operations-compliance-regulatory-P01-T003: Create Spring Boot service skeleton and runtime configuration

| Field | Value |
| --- | --- |
| Phase | P01 - From Scratch App Foundation And Delivery Runtime |
| Priority | P0 |
| Source evidence | [API-first architecture](../../../../../api-first-product-suite-architecture.md), [Technology stack guidance](../../../../../technology-stack-guidance.md), [App summary](../../../../../security-operations-compliance-regulatory.md) |
| Feature or module | From-scratch app foundation |
| Build area | API/Ops |
| Dependencies | DT-01-security-operations-compliance-regulatory-P01-T002 |
...
- Set the Java package under `com.telcosuite.epdg.security_compliance_regulatory`.
...
### DT-01-security-operations-compliance-regulatory-P01-T004: Establish PostgreSQL migration, schema, repository, and seed baseline
...
| Feature or module | From-scratch app foundation |
| Build area | Data |
| Dependencies | DT-01-security-operations-compliance-regulatory-P01-T003 |
...
- Keep the app's write/read models in schema `security_compliance_regulatory`.
...
1. Given a clean PostgreSQL database, when Flyway runs the app's migrations, then only schema `security_compliance_regulatory` and its tables are created.
...
### DT-01-security-operations-compliance-regulatory-P01-T005: Define TMF/OpenAPI contract workspace and API versioning baseline

| Field | Value |
| --- | --- |
| Phase | P01 - From Scratch App Foundation And Delivery Runtime |
| Priority | P0 |
| Source evidence | [TMF review](../../tmf-api-ddl-reviews/security-compliance-regulatory.md), [API-first architecture](../../../../api-first-product-suite-architecture.md) |
| Feature or module | From-scratch app foundation |
| Build area | API/Test |
| Dependencies | DT-01-security-operations-compliance-regulatory-P01-T004 |
...
### DT-01-security-operations-compliance-regulatory-P01-T006: Implement authentication, authorization, tenant, and evidence context baseline
...
| Feature or module | From-scratch app foundation |
| Build area | Security |
| Dependencies | DT-01-security-operations-compliance-regulatory-P01-T005 |
...
### DT-01-security-operations-compliance-regulatory-P01-T007: Create event, outbox, workflow, and integration contract baseline
...
| Dependencies | DT-01-security-operations-compliance-regulatory-P01-T006 |
...
- `event_outbox` table in schema `security_compliance_regulatory`.
...
### DT-01-security-operations-compliance-regulatory-P01-T008: Build shared app UI patterns for queues, records, forms, dashboards, and evidence views

| Field | Value |
| --- | --- |
| Phase | P01 - From Scratch App Foundation And Delivery Runtime |
| Priority | P1 |
| Source evidence | [UI design system](../../../../../telcosuite-ui-design-system.md), [App summary](../../../../../security-operations-compliance-regulatory.md) |
| Feature or module | From-scratch app foundation |
| Build area | UI/Test |
| Dependencies | DT-01-security-operations-compliance-regulatory-P01-T007 |
...
### DT-01-security-operations-compliance-regulatory-P01-T009: Add local developer environment, run scripts, seed data, and demo smoke flow
...
| Dependencies | DT-01-security-operations-compliance-regulatory-P01-T008 |
...
### DT-01-security-operations-compliance-regulatory-P01-T010: Wire CI quality gates and test pyramid scaffolding
...
| Feature or module | From-scratch app foundation |
| Build area | CI/Test |
| Dependencies | DT-01-security-operations-compliance-regulatory-P01-T009 |
...
### DT-01-security-operations-compliance-regulatory-P01-T011: Establish observability, operations, support, and deployment skeleton
...
| Dependencies | DT-01-security-operations-compliance-regulatory-P01-T010 |
...
### DT-01-security-operations-compliance-regulatory-P01-T012: Prove the first end-to-end vertical slice through UI, API, database, event, security, and CI

| Field | Value |
| --- | --- |
| Phase | P01 - From Scratch App Foundation And Delivery Runtime |
| Priority | P0 |
| Source evidence | [Repository strategy](../../../../repository-strategy.md), [App summary](../../../../../security-operations-compliance-regulatory.md) |
| Feature or module | From-scratch app foundation |
| Build area | Full-stack/Test/Release |
| Dependencies | DT-01-security-operations-compliance-regulatory-P01-T011 |
