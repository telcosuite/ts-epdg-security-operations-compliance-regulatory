# Security Operations, Compliance, And Regulatory Implementation File Usage

Reviewed: 2026-06-14

## Purpose

Use this guide when building `Security Operations, Compliance, And Regulatory`. It explains which generated files matter, when to read them, and how they drive Angular, Spring Boot, PostgreSQL, TMF API, event, and privacy work.
...
| Primary APIs | TMF720, TMF672, TMF696, TMF621, TMF644, TMF667, TMF707, TMF710, TMF681, TMF735, TMF724, TMF655 |
| Starter tables | 10 |
...
| App overview | [../security-operations-compliance-regulatory.md](../security-operations-compliance-regulatory.md) | Concise product scope, app purpose, TMF API usage, ownership, integrations, and first-release direction. |
...
| App TMF review | [../../tmf-api-ddl-reviews/security-compliance-regulatory.md](../../tmf-api-ddl-reviews/security-compliance-regulatory.md) | TMF APIs, resource-to-table mapping, field handling, event baseline, privacy/retention/audit baseline. |
...
| App V002+ migration | [../../../../database/postgres/suites/ts_enterprise_platform_governance/V004__refine_security_compliance_regulatory_tmf_core.sql](../../../../database/postgres/suites/ts_enterprise_platform_governance/V004__refine_security_compliance_regulatory_tmf_core.sql) | Promotes common TMF columns and creates app support tables, event_contract, and privacy_retention_policy. |
...
9. Use `security_compliance_regulatory.event_contract` as the baseline event register and `security_compliance_regulatory.event_outbox` for publication.
10. Use `security_compliance_regulatory.privacy_retention_policy` as the baseline for masking, audit, retention, legal hold, and residency handling.
...
- Write only inside schema `security_compliance_regulatory` for this app's operational data.
